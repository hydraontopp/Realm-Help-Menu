    ...
    try {
        ...
        if (sender.hasTag('admin')) {
            if (!args[0]) {
                ...
                //sender.tellraw(`§¶§7[§eConsole§7]§f ► §c§lplayerfound : ${playerfound.getName()}`);
                ...
                sender.tellraw(`§¶§7[§eConsole§7]§f ► §c§lError 7: command failure`);
            }
        } else {
            sender.tellraw(`§¶§7[§eConsole§7]§f ► §c§lError 4: Only Staff can use this command`);
        }
        
    } catch (error) {
        sender.tellraw(`§¶§7[§eConsole§7]§f ► §c§lError 8: command failure`);

        ...
        if (sender.scoreTest('togglecommands') === 0) {
            ...
            if (cmdUsage.includes(args[0])) {
                if (!args[1]) {
                    ...
                    sender.tellraw(`§¶§7[§eConsole§7]§f ► §c§lPlease Provide Player Name`);
                    ...
                    if (PlayerArgString.one) {
                        ...
                        sender.removeTag('stats_temp');
                        return tellrawStaff(`§¶§7[§eConsole§7]§f ► §d${name} §bused stats §d${args.join(' ')}`);
                    }
                    else {
                        sender.tellraw(`§¶§7[§eConsole§7]§f ► §c§lNo player by that name`);
                    }
                }
                    ...
                    if (PlayerArgString.two) {
                        ...
                        return sender.tellraw(`§¶§7[§eConsole§7]§f ► §c§lNo player by that name`);
                    }
                }
                    ...
                    sender.tellraw(`§¶§7[§eConsole§7]§f ► §c§lError : Did not Understand Player Name`);
                ...
                sender.removeTag('stats_temp');
                sender.runCommand(`playsound note.pling @s ~ ~ ~`);
                return tellrawStaff(`§¶§7[§eConsole§7]§f ► §d${name} §bchecked their stats`);
            } else {
                return sender.tellraw(`§¶§7[§eConsole§7]§f ► §c§lError : Command Failed`);
            }
        }
    } catch (error) {
